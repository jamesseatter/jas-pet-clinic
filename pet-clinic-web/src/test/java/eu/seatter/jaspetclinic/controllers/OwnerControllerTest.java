...
class OwnerControllerTest {
    ...
    @Test
    void processFindFormNoNameReturnAll() throws Exception {
        //The controller will add % around the entered find string.
        // In the case the find field is empty then the service will receive "%%"
